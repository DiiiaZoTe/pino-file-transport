...
A high-performance Pino transport for file logging with configurable rotation, archiving, and retention. Built on [SonicBoom](https://github.com/pinojs/sonic-boom) for optimized I/O. Designed for Node.js and Bun projects. Inspired by a first multi-stream version [pino-api-logger](https://github.com/DiiiaZoTe/pino-api-logger)
...
This README file was generated by ai based on the source files found in the repository.